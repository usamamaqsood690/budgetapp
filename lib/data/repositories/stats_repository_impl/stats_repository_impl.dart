...
class StatsRepositoryImpl implements StatsRepository {
  final StatsRemoteDataSourceImpl remoteDataSource;
  ...
  @override
  Future<Either<Failure, StatsResponse>> getStatsSummary() async {
    if (!await networkInfo.isConnected) {
      return const Left(NetworkFailure(message: 'No internet connection'));
    }

    try {
      final result = await remoteDataSource.getStatsSummary();
      return Right(result);
